...
import { defaultAuthor } from '@/src/data/articles';
import { FadeImage } from '@/src/components/FadeImage';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'About Jane Doe',
  description: 'Learn more about Jane Doe, writer, film photographer, and editor of this personal journal.',
  alternates: {
    canonical: `${process.env.APP_URL || 'https://blog3-mauve.vercel.app'}/about`,
  },
};
        ...
        <article className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="flex flex-col md:flex-row gap-12 lg:gap-20 items-start">
            <div className="w-full md:w-1/2">
              <div className="aspect-[4/5] overflow-hidden rounded-sm bg-ink/5 sticky top-28">
                <FadeImage 
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center pt-4 md:pt-0">
              ...
              <div className="mt-16 pt-12 border-t border-ink/10">
                ...
                <div className="flex flex-col gap-4 text-sm">
                  <a href="mailto:hello@janedoe.com" className="text-ink-light hover:text-accent transition-colors font-medium">hello@janedoe.com</a>
                  <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-ink-light hover:text-accent transition-colors font-medium">Twitter: {defaultAuthor.twitter}</a>
                  <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-ink-light hover:text-accent transition-colors font-medium">Instagram: {defaultAuthor.instagram}</a>
                </div>
              </div>
            </div>
          </div>
